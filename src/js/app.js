...
function mostrarServicios(servicios) {
  servicios.forEach((servicio) => {
    ...
    servicioDiv.onclick = function () {
      //usuamos un callback para poder pasarle el servicio completo
...
function seleccionarServicio(servicio) {
  ...
  if (servicios.some((agregado) => agregado.id === id)) {
    ...
    //agregarlo
    cita.servicios = [...servicios, servicio]; // se toma una copia del arreglo de servicios y le agregamos el nuevo servicio
...
function seleccionarHora() {
  ...
  inputHora.addEventListener("input", function (e) {
    ...
    const hora = horaCita.split(":"); // serve para separar cadenas de texto en base a un separador
...
function mostrarResumen() {
  ...
  //limbiar el contenido de resumen
...
async function reservarCita() {
  ...
  try {
    ...
    //le tenemos que asignar el arreglo o archivo de configuracion a fetch cuando se van a enviar datos
